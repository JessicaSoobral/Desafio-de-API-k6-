...
export default function () {
  ...
  const ID_PRODUTO = 'ug3Mo44GoMUsjcqx';
  ...
  check(response, {
    'Status code 200 ': (r) => r.status === 400,
    'Registro alterado com sucesso': (r) => JSON.parse(r.body).message === 'Já existe produto com esse nome',
  });
}